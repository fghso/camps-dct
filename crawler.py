...
class BaseCrawler:
    ...
    def crawl(self, resourceID, filters):
        ...
        Args:
            ...
            * *filters* (list): All data (if any) generated by the filters added to server. Sequential filters appear first, in the same order that they appear in the configuration file. Parallel filters come next in undetermined order.
